"""
RQ2 FEATURE IMPORTANCE - DEVELOPMENT SCRIPT
...
FOR LOCAL TESTING: Uses test data and local model
FOR PRODUCTION: Use run_rq2_feature_importance_mona.py in MONA

Expected Runtime: ~2 minutes

Outputs:
-   outputs_synthetic/tables/rq2_feature_importance.csv       # Feature importance scores
-   outputs_synthetic/tables/rq2_best_model_confusion_matrix.csv  # Confusion matrix for best model
"""
